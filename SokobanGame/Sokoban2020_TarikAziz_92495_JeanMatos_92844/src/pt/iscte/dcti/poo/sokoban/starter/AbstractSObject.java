...
public abstract class AbstractSObject implements ImageTile {
	...
	public AbstractSObject(Point2D p, int layer, boolean unpassable, boolean movable,
			               boolean isObjective) {
		position = p; 
		this.layer = layer;
	...
	protected void setPosition(Point2D p) { position = p; }

	public abstract void doSomething(AbstractSObject a);

	public boolean isMoveable() { return movable; }

	public boolean isUnpassable() { return unpassable; }

	public boolean isSwallowable() { return true; }

    public boolean isObjective() { return isObjective; }

	public boolean hasPower() { return hasPower; }

	public void setMobility(boolean t) { movable = t; }

	public void setHasPower(boolean t) { hasPower = t; }
	...
	public void validatePosition(Point2D newPosition) {
		...
		if (newPosition.getX() >= 0 && newPosition.getX() < SokobanGame.WIDTH && newPosition.getY() >= 0
				&& newPosition.getY() < SokobanGame.HEIGHT)
